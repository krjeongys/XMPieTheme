...
import { getCurrentCulture, queryOrCookieStrToObj, isServer, getNextConfig } from '$ustoreinternal/services/utils'
...
const ngToLegacyConversions = [
  ...
  {
    reg: /.*\/notice-item-list/,
    generateURL: () => `CustomSideBar/QAndAPage.aspx`
  },
  {
    reg: /.*\/notice-item-detail/,
    generateURL: () => `CustomSideBar/NoticeItemDetail.aspx`
  },
  {
    reg: /.*\/product-enquiry-board/,
    generateURL: () => `ProductEnquiryBoard.aspx`
  },
  {
    reg: /.*\/product-enquiry-board-detail/,
    generateURL: () => `ProductEnquiryBoardDetail.aspx`
  },
  {
    reg: /.*\/product-enquiry-answer-page/,
    generateURL: () => `ProductEnquiryAnswerPage.aspx`
  },
  {
    reg: /.*\/product-enquiry-edit-detail/,
    generateURL: () => `ProductEnquiryEditDetail.aspx`
  },
  {
    reg: /.*\/product-enquiry-write/,
    generateURL: () => `ProductEnquiryWrite.aspx`
  }
]
...
const legacyToNGConversions = [
  ...
  {
	reg: /\/ustore\/customsidebar\/qandapage/,
	page: 'notice-item-list'
  },
  {
	reg: /\/ustore\/customsidebar\/noticeitemdetail/,
	page: 'notice-item-detail'
  },
  {
	reg: /\/ustore\/productenquiryboard/,
	page: 'product-enquiry-board'
  },
  {
	reg: /\/ustore\/productenquiryboarddetail/,
	page: 'product-enquiry-board-detail'
  },
  {
	reg: /\/ustore\/productenquiryanswerpage/,
	page: 'product-enquiry-answer-page'
  },
  {
	reg: /\/ustore\/productenquiryeditdetail/,
	page: 'product-enquiry-edit-detail'
  },
  {
	reg: /\/ustore\/productenquirywrite/,
	page: 'product-enquiry-write'
  }
]
...
class LegacyIframeHandler {
  ...
  appendMessagingParams(url) {
    const { showThemeAsDraft } = themeContext.get()
